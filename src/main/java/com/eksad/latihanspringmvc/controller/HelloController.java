...
public class HelloController {
	...
	public String toGoogle() {
		...
		return "<a href='https://www.google.com' target='_blank'> Klik disini menuju Google dengan tab baru</a></br>"

		+ "<a href='https://www.google.com'> Klik disini menuju Google </a>";
	}
